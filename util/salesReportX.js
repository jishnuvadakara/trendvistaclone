...
//           paymentmethod: totalSalesAmount.toFixed(2),
//         });

//         const excelFilePath = `public/SaleREcel/sales-report-${formattedStartDate}-${formattedEndDate}.xlsx`;
...
module.exports = {
  downloadReport: async (
    ...
    try {
      ...
      if (downloadformat === "excel") {
        // Your Excel generation code remains unchanged
        const workbook = new exceljs.Workbook();
                const worksheet = workbook.addWorksheet("Sales Report");
